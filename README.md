...
- **Ana Capability:** Confirmation of Payee and name matching
- **Dönüşüm Wave:** 1
...
- `Confirmation of Payee and name matching` kapsamında kod, sözleşme, test, runbook ve release artefaktları.
